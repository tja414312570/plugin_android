 ...
 *
 */
public class DefaultSqlSessionExecutor implements SqlSession{
    private final SqlFragmentManager sqlFragmentManager;
    private final SQLiteDatabase sqLiteDatabase;

    public DefaultSqlSessionExecutor(SQLiteDatabase sqLiteDatabase, SqlFragmentManager sqlFragmentManager) {
